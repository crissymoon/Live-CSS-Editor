 ...
 *   GET  ?action=restore&name=...&id=  -- restore a backup to the active slot
 ...
 *   POST ?action=sync_to_bridge        -- save to DB + write files to projects/
 *
 * Crissy's Style Tool
...
// ---------------------------------------------------------------------------
// Paths -- always relative to this file so it works regardless of doc root
// ---------------------------------------------------------------------------
...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && $action === 'save') {
        ...
        // Write update signal so the browser can detect changes
