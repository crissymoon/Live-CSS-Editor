...
(function (LiveCSS) {
    ...
    function buildRunPane() {
        return [
            ...
            '      </div>',
            '      <form class="agent-task-form" autocomplete="off" onsubmit="return false;">',
            ...
            '          <span id="agentModelPick" class="agent-model-label">Claude Haiku 4.5 + GPT-4 Mini</span>',
            ...
            '          <select class="agent-select" id="agentTask" aria-label="Task" autocomplete="off">' + C.TASK_OPTIONS.map(function(o){ return '<option value="'+o.value+'">'+o.label+'</option>'; }).join('') + '</select>',
            '        </div>',
            '        <div class="agent-task-row" id="agentFuzzyRow" style="display:none;">',
            '          <span class="agent-task-label">Search</span>',
            '          <input class="agent-input" id="agentFuzzyInput" placeholder="fuzzy search themes, variables, components..." style="flex:1;" autocomplete="off">',
            ...
            '          <select class="agent-select" id="agentThemeSelect" aria-label="Theme" autocomplete="off"></select>',
            ...
            '        </div>',
            '        <div class="agent-instruction-row">',
            '          <span class="agent-task-label">Instruction</span>',
            '          <textarea class="agent-input" id="agentInstruction" rows="2" placeholder="Describe what you want the agent to do..." autocomplete="off" spellcheck="false"></textarea>',
            '        </div>',
            '        <div class="agent-task-row">',
    ...
    function buildChatPane() {
        return [
            ...
            '    <select class="agent-select" id="chatProvider" aria-label="Chat Provider" autocomplete="off"></select>',
            '    <select class="agent-select" id="chatModel" aria-label="Chat Model" autocomplete="off"></select>',
            ...
            '  <form class="agent-chat-input-row" autocomplete="off" onsubmit="return false;">',
            '    <div class="agent-chat-input-wrap">',
            '      <textarea class="agent-input agent-chat-input" id="agentChatInput" rows="3" placeholder="Ask anything about CSS or code..." spellcheck="false" autocomplete="new-password"></textarea>',
