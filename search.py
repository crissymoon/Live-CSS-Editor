...
AI_MODELS = [
    {
        ...
        "default": False,
        "used_in": [
            "c_tools/tui_agent/agent.py",
            "c_tools/tui_agent/project_mode.py",
        ],
    },
    {
    ...
    },
    {
        ...
        "default": False,
        "used_in": [
            "agent-flow/mood_ck/mood_check.py",
            "agent-flow/mood_ck/emi_model/engine.py",
        ],
    },
]
...
WATCH_FILES = [
    ...
    "lines_count.py",
    "search.py",
    "c_tools/tui_agent/main.py",
    "c_tools/tui_agent/agent.py",
    "c_tools/tui_agent/convo.py",
    "c_tools/tui_agent/project_mode.py",
    "c_tools/tui_agent/db.py",
    "c_tools/tui_agent/merger.py",
    "agent-flow/mood_ck/mood_check.py",
    "ai/config.json",
    "ai/config.php",
    "ai/phrases.php",
    ...
    "ai/anthropic.php",
    "ai/openai.php",
    "agent-flow/prompt_inj_guard/model/rule_guard.py",
